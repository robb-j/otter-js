 ...
 * @param  {string} attrName  The name of the attribute (store on Attribute & used for errors)
 * @param  {string} modelName The name of the model the attrbute belongs to (used for errors)
 * @return {Attribute} A new attribute instance
 */
function parseAttribute(raw, types, attrName, modelName) {
  ...
  return new types[type](attrName, options)
}
