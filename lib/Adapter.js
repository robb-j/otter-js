...
class Adapter {
  ...
  makeQuery(modelName, query, options) {
    ...
    return new Query(modelName, query, options)
  }
   ...
   */
  async update(modelName, query, values, options) { }
   ...
   */
  async destroy(modelName, query, options) { }
