...
module.exports = class PolymorphicAttribute extends AddTraits(Attribute, PolymorphicType) {
  ...
  validateSelf(Otter, ModelType) {
    this.validateTypes(Otter, ModelType, this.options.types)
  }
  
  processOptions(Otter, ModelType) {
    this.options.Types = this.processTypes(Otter, ModelType, this.options.types)
  }
