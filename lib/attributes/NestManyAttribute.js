...
const { AddTraits } = require('../utils')

const NestingType = require('../utils/traits/NestingType')
const AssociativeType = require('../utils/traits/AssociativeType')
...
module.exports = class NestManyAttribute extends AddTraits(Attribute, NestingType, AssociativeType) {
  ...
  associatedType() { return this.ClusterType }
