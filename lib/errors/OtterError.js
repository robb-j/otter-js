const getUsingDot = require('../utils/dot/get')
const mergeUsingDot = require('../utils/dot/merge')

const attrErrors = require('./attrErrors')
...
class OtterError extends Error {
  ...
  static registerTypes(namespace, types) {
    mergeUsingDot(ErrorTypes, namespace, types)
  }
...
// Register extra errors
attrErrors(OtterError)


// Export our error
module.exports = OtterError
